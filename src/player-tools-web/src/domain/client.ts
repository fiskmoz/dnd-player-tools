...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  characterSheets = {
    /**
     * @description gets a character sheet by id
     *
     * @tags character_sheets
     * @name GetCharacterSheetCharacterSheetsCharacterSheetIdGet
     ...
     *
     * @tags character_sheets
     * @name CreateCharacterSheetCharacterSheetsPost
  ...
  healthcheck = {
    /**
     * @description Check if application can respond.
     *
     * @name HealthHealthcheckGet
     * @summary Health
     * @request GET:/healthcheck
     */
    healthHealthcheckGet: (params: RequestParams = {}) =>
